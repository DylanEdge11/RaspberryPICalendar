...
Tablet screen-fit correction: constrained display to available viewport height, removed oversized minimum card/month-row heights, compacted headers and retained a bounded portrait photo strip. Browser checks confirmed no page-height overflow for week/month at 1024×600 and month at 800×1280. Crowded month cells retain internal scrolling/day-list access. Controls unchanged. Local change; Pi installation pending.
